...
// never 타입은 어떻게 거르지 **
type FilterOut<T extends unknown[], Filter> = T extends [infer F, ...infer R] ?
    [F] extends [Filter] ?
        [...FilterOut<R, Filter>] : [F, ...FilterOut<R, Filter>]
    : T extends [Filter] ?
        [] : T;
...
type cases = [
    ...
    Expect<Equal<FilterOut<[never, 1, 'a', undefined, false, null], null | undefined>, [1, 'a', false]>>, // **
